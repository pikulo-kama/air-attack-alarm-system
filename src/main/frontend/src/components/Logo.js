...
const Logo = () => {
    ...
    return (
        <svg version="1.1" id="Layer_1" width="40px" height="40px"
            ...
            <circle style={{fill: activeModeData.logo.lowerBand}} cx="256" cy="198.773" r="160"/>
            <path style={{fill: activeModeData.logo.upperBand}} d="M96,198.773c0-88.367,71.634-160,160-160s160,71.633,160,160"/>
